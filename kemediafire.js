...
var str = currentURL;
var res = str.replace("http://kemediafire.blogspot.com/2018/03/kemediafire.html?url=", "");
...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);a_to_ve[i].href="http://kemediafire.blogspot.com/2018/03/kemediafire.html?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
...
<script src='https://cdn.rawgit.com/dedi96/safelink/6b9837aa/pemanggil%20script.js' type='text/javascript'/>
<script type='text/javascript'>
...
Komentar Terbaru
    ...
    Netters Mania
    Netters ManiaSaya udah cobak tapi kok gak mau muncul ya gan, uda ada bebe…
    Dedi Islafuddin
    Dedi IslafuddinScript ini auto convert link, sudah otomatis ngeconvert linl…
    Heni Agustini
    Heni AgustiniBeararti script ini ngegenerate link manual ya, kalau yang m…
    Dedi Islafuddin
    Dedi IslafuddinBisa sih, kalau gk bisa coba pake mode create file di web ny…
    Indri Lightheaven
    Indri Lightheavenum kenapa y jd ga bisa uplod ke github, apa gimana y.

Artikel Terbaru

    Cara Mudah Download Foto dan Video Instagram Tanpa Aplikasi

    Mar-04 - 2018 | No Comments
    2 Cara Terbaru Menyimpan Foto Instagram Lewat PC/Komputer

    Mar-03 - 2018 | No Comments
    Cara Memasang Iklan Otomatis Google Adsense di Blog

    Feb-23 - 2018 | 3 Comments
    Cara Mengubah Kuota Videomax Menjadi Kuota Flash Reguler 24 Jam 100% Work

    Feb-13 - 2018 | 2 Comments
    Cara Ampuh Mengatasi Limit Download Google Drive

    Feb-09 - 2018 | No Comments
